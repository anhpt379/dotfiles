...
alias pp='command sudo HOME=/root TERMINFO=/home/panh/.terminfo /bin/puppet agent -t'
alias ppf='sudo killall puppet 2>/dev/null; pp --enable; pp'
alias ppa='command sudo HOME=/root TERMINFO=/home/panh/.terminfo /bin/puppet agent -t --environment=panh'
