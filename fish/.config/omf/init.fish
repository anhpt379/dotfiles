...
set -gx FZF_DEFAULT_OPTS    '--pointer=" >" --prompt="  " --color fg:#DCDFE4,bg:-1,hl:#DCDFE4,fg+:#FFCC66,bg+:#1C1E23,hl+:#FFCC66,info:#919BAA,prompt:#C068DF,pointer:#3BB0E0,marker:#55CABE,spinner:#919BAA --no-multi --reverse --height=40% --info=inline --bind=tab:accept,ctrl-j:ignore,ctrl-k:ignore'
